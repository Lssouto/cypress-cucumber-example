...
export const TODO_SHOW_ALL  = '.filters li:nth-child(1) a';
export const TODO_ACTIVED   = '.filters li:nth-child(2) a';
export const TODO_COMPLETED = '.filters li:nth-child(3) a';